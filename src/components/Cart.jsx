...
export default function Button({ theme, styled, click, children }) {
    ...
    return (<div className={` transition-all ease-in-out duration-300  z-40`}>
        <button type="button" onClick={HandlerCheckOut} class="h-[40px] w-[40px] my-1 text-blue-700 bg-[#008BBA] border-[2px] border-white font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
            { tienda !== 'Recetar'
            ...
            <span className='inline-block absolute top-[10px] text-white right-[10px] bg-[#008BBA] w-[16px] text-[12px] rounded-full border border-white'>{
